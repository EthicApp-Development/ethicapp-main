const esCL = {
  ...
  sessionDetail: {
    ...
    phasesTitle: 'Fases',
    caseTab: 'Caso',
    caseViewerHint: 'Si el documento no carga correctamente, abre el PDF en una pestaña nueva.',
    openCaseInNewTab: 'Abrir en nueva pestaña',
    caseDocumentProcessing: 'El documento del caso se está procesando.',
    caseDocumentProcessingFailed: 'No se pudo procesar el documento del caso.',
    caseDocumentPageLabel: 'Página {{page}}',
    caseDocumentPageAlt: 'Página {{page}} del documento del caso',
    phaseN: 'Fase',
    ...
    previousResponsesDescription: 'Estas son respuestas enviadas por tu grupo en fases anteriores.',
    ...
    previousResponsesSelectionLabel: 'Valor seleccionado',
    ...
    chatExternalAgentAuthor: 'Agente externo',
    ...
    externalResponseProcessing: 'Un servicio externo está procesando tu respuesta...',
    externalResponseProcessingButton: 'Esperando retroalimentación externa...',
    ...
    externalResultLoadError: 'No fue posible cargar el componente del resultado.',
    externalResultDismiss: 'Cerrar',
    atsFeedbackTitle: 'Retroalimentación del tutor de argumentación',
    ...
    atsCriterionQualifier: 'Calificador',
    atsClaimInFavor: 'A favor',
    atsClaimAgainst: 'En contra',
    atsClaimNeutral: 'Neutral',
    argumentTutorTitle: 'Tutor de argumentación',
    argumentTutorStrengths: 'Fortalezas',
    argumentTutorSuggestions: 'Sugerencias',
