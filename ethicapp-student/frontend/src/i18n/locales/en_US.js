const enUS = {
  ...
  sessionDetail: {
    ...
    previousResponsesDescription: 'These are responses submitted by your group in earlier phases selected by the activity design.',
    ...
    previousResponsesSelectionLabel: 'Selection',
