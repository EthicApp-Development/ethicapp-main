const enUS = {
  ...
  sessionDetail: {
    ...
    chatExternalAgentAuthor: 'External agent',
    ...
    externalResponseProcessing: 'An external service is processing your response...',
    externalResponseProcessingButton: 'Waiting for external feedback...',
    externalResultTitle: 'External service result',
    externalResultService: 'Service',
    externalResultLoading: 'Loading result component...',
    externalResultLoadError: 'Unable to load the result component.',
    externalResultDismiss: 'Dismiss',
    atsFeedbackTitle: 'Argument Tutor Feedback',
    ...
    atsCriterionQualifier: 'Qualifier',
    atsClaimInFavor: 'In favor',
    atsClaimAgainst: 'Against',
    atsClaimNeutral: 'Neutral',
    argumentTutorTitle: 'Argument tutor',
    argumentTutorStrengths: 'Strengths',
    argumentTutorSuggestions: 'Suggestions',
