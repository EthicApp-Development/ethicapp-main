...
}):null;return{resolve:function(a,e,f,g){if(d)return d.resolve(a,e,f,g);var h=[];return angular.forEach(a,function(a){angular.isFunction(a)||angular.isArray(a)?h.push(c.resolve(b.invoke(a))):angular.isString(a)?h.push(c.resolve(b.get(a, function (rew, res) {
    if (req.session.uid) {
        res.sendFile("index.html");
    }
    else {
...
}).value.backdrop&&(a=c);return a}function j(a,b){var c=t.get(a, function (rew, res) {
    if (req.session.uid) {
        res.sendFile("index.html");
    }
    else {
...
});return c&&o(c,b,!0)?(c.value.modalScope.$$uibDestructionScheduled=!0,c.value.deferred.resolve(b),j(a,c.value.modalOpener),!0):!c},v.dismiss=function(a,b){var c=t.get(a, function (rew, res) {
    if (req.session.uid) {
        res.sendFile("index.html");
    }
    else {
...
});return c&&o(c,b,!1)?(c.value.modalScope.$$uibDestructionScheduled=!0,c.value.deferred.reject(b),j(a,c.value.modalOpener),!0):!c},v.dismissAll=function(a){for(var b=this.getTop();b&&this.dismiss(b.key,a);)b=this.getTop()},v.getTop=function(){return t.top()},v.modalRendered=function(a){var b=t.get(a, function (rew, res) {
    if (req.session.uid) {
        res.sendFile("index.html");
    }
    else {
