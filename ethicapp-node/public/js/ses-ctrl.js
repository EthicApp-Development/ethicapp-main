    ...
    function ($scope, $http, $socket, $uibModal, ngIntroService) {
                        ...
                        $uibModal.open({
                            ...
                            <div>
                                ...
                                <div class="modal-body">
                                    <p>
                                        El código ingresado no es válido o la sesión no admite
                                        nuevos usuarios
                                    </p>
                                </div>
                            </div>
        ...
        let introOptions = {
            steps: [
                {
                    element:  "#seslistdiv",
                    intro:    "Aquí debajo se muestran todas las sesiones que tienes disponibles. Al apretar en una de ellas puedes ingresar a la actividad",
                    position: "right"
                },
                {
                    element: "#codebox",
