(() => {
      ...
      (function(window2) {
        ...
        function minErr(module2, ErrorConstructor) {
          ...
          return function() {
            ...
            message += "\nhttp://errors.angularjs.org/1.5.11/" + (module2 ? module2 + "/" : "") + code;
        ...
        function angularInit(element, bootstrap2) {
          ...
          if (appElement) {
            if (!isAutoBootstrapAllowed) {
              window2.console.error("Angular: disabling automatic bootstrap. <script> protocol indicates an extension, document.location.href does not match.");
              return;
            }
        ...
        function bootstrap(element, modules, config) {
          ...
          if (isFunction(angular3.resumeDeferredBootstrap)) {
        ...
        function getTestability(rootElement) {
          var injector = angular3.element(rootElement).injector();
          if (!injector) {
            throw ngMinErr(
              "test",
          ...
          if (!type) {
            ...
            var removeHandler = function(type2) {
              ...
              if (!(isDefined(fn) && listenerFns && listenerFns.length > 0)) {
                removeEventListenerFn(element, type2, handle);
                delete events[type2];
              }
            };
        ...
        var JQLitePrototype = JQLite.prototype = {
          ready: function(fn) {
            ...
            if (window2.document.readyState === "complete") {
              window2.setTimeout(trigger);
            } else {
              this.on("DOMContentLoaded", trigger);
              JQLite(window2).on("load", trigger);
            }
          },
          toString: function() {
            var value = [];
          ...
          attr: function(element, name, value) {
            ...
            if (BOOLEAN_ATTR[lowercasedName]) {
              if (isDefined(value)) {
                ...
                return element[name] || (element.attributes.getNamedItem(name) || noop).specified ? lowercasedName : void 0;
              }
            ...
            var addHandler = function(type2, specialHandlerWrapper, noEventListener) {
              ...
              if (!eventFns) {
                ...
                if (type2 !== "$destroy" && !noEventListener) {
                  addEventListenerFn(element, type2, handle);
                }
              }
              eventFns.push(fn);
            };
        ...
        function createInjector(modulesToLoad, strictDi) {
          ...
          function loadModules(modulesToLoad2) {
            ...
            forEach(modulesToLoad2, function(module2) {
              ...
              loadedModules.put(module2, true);
        ...
        function Browser(window3, document2, $log, $sniffer) {
          var self = this, location = window3.location, history = window3.history, setTimeout = window3.setTimeout, clearTimeout = window3.clearTimeout, pendingDeferIds = {};
          self.isMock = false;
        ...
        function $CompileProvider($provide, $$sanitizeUriProvider) {
          ...
          function getDirectiveRequire(directive) {
            ...
            if (!isArray(require2) && isObject(require2)) {
              forEach(require2, function(value, key) {
                var match = value.match(REQUIRE_PREFIX_REGEXP);
                var name = value.substring(match[0].length);
                if (!name) require2[key] = match[0] + key;
              });
            }
            return require2;
          }
            ...
            function($injector, $interpolate, $exceptionHandler, $templateRequest, $parse, $controller, $rootScope, $sce, $animate, $$sanitizeUri) {
              ...
              function compile($compileNodes, transcludeFn, maxPriority, ignoreDirective, previousCompileContext) {
                ...
                for (var i = 0, len = $compileNodes.length; i < len; i++) {
                  ...
                  if (domNode.nodeType === NODE_TYPE_TEXT && domNode.nodeValue.match(NOT_EMPTY)) {
                    jqLiteWrapNode(domNode, $compileNodes[i] = window2.document.createElement("span"));
                  }
                }
                ...
                switch (nodeType) {
                  case NODE_TYPE_ELEMENT:
                    ...
                    for (var attr, name, nName, ngAttrName, value, isNgAttr, nAttrs = node.attributes, j = 0, jj = nAttrs && nAttrs.length; j < jj; j++) {
                      ...
                      if (isNgAttr) {
                        name = name.replace(PREFIX_REGEXP, "").substr(8).replace(/_(.)/g, function(match2, letter) {
                      ...
                      if (isObject(directiveValue)) {
                        ...
                        forEach($compileNode.contents(), function(node) {
                          ...
                          if (slotName2) {
                            ...
                            slots[slotName2] = slots[slotName2] || [];
                            slots[slotName2].push(node);
                          } else {
                            $template.push(node);
                          }
                        });
              ...
              function initializeDirectiveBindings(scope, attrs, destination, bindings, directive) {
                ...
                function recordChanges(key, currentValue, previousValue) {
                  if (isFunction(destination.$onChanges) && currentValue !== previousValue && // eslint-disable-next-line no-self-compare
          ...
          this.$get = ["$injector", "$window", function($injector, $window) {
            return function $controller(expression, locals, later, ident) {
              ...
              if (isString(expression)) {
                ...
                expression = controllers.hasOwnProperty(constructor) ? controllers[constructor] : getter(locals.$scope, constructor, true) || (globals ? getter($window, constructor, true) : void 0);
                if (!expression) {
                  throw $controllerMinErr(
                    "ctrlreg",
            ...
            function($httpBackend, $$cookieReader, $cacheFactory, $rootScope, $q, $injector) {
              ...
              function $http(requestConfig) {
                ...
                function mergeHeaders(config2) {
                  var defHeaders = defaults.headers, reqHeaders = extend({}, config2.headers), defHeaderName, lowercaseDefHeaderName, reqHeaderName;
                ...
                function serverRequest(config2) {
                  ...
                  if (isUndefined(config2.withCredentials) && !isUndefined(defaults.withCredentials)) {
                    config2.withCredentials = defaults.withCredentials;
                  }
        ...
        function createHttpBackend($browser, createXhr, $browserDefer, callbacks, rawDocument) {
          return function(method, url, post, callback, headers, timeout, withCredentials, responseType, eventHandlers, uploadEventHandlers) {
            ...
            function completeRequest(callback2, status, response, headersString, statusText) {
              if (isDefined(timeoutId)) {
                $browserDefer.cancel(timeoutId);
              }
              jsonpDone = xhr = null;
              callback2(status, response, headersString, statusText);
        ...
        function $InterpolateProvider() {
          ...
          this.$get = ["$parse", "$exceptionHandler", "$sce", function($parse, $exceptionHandler, $sce) {
            ...
            function $interpolate(text, mustHaveExpression, trustedContext, allOrNothing) {
              ...
              var startIndex, endIndex, index = 0, expressions = [], parseFns = [], textLength = text.length, exp, concat2 = [], expressionPositions = [];
        ...
        function $LogProvider() {
          ...
          this.$get = ["$window", function($window) {
            ...
            function consoleLog(type) {
              var console2 = $window.console || {}, logFn = console2[type] || console2.log || noop, hasApply = false;
              try {
              ...
              if (hasApply) {
                return function() {
                  ...
                  return logFn.apply(console2, args);
                };
              }
        ...
        function $ParseProvider() {
          ...
          this.$get = ["$filter", function($filter) {
            ...
            function inputsWatchDelegate(scope, listener, objectEquality, parsedExpression, prettyPrintExpression) {
              ...
              return scope.$watch(function expressionInputsWatch(scope2) {
                ...
                for (var i2 = 0, ii2 = inputExpressions.length; i2 < ii2; i2++) {
                  ...
                  if (changed || (changed = !expressionInputDirtyCheck(newInputValue, oldInputValueOfValues[i2]))) {
            ...
            function oneTimeWatchDelegate(scope, listener, objectEquality, parsedExpression) {
              ...
              unwatch = scope.$watch(
                function oneTimeWatch(scope2) {
                  return parsedExpression(scope2);
                },
                /** @this */
                function oneTimeListener(value, old, scope2) {
                  lastValue = value;
                  if (isFunction(listener)) {
                    listener.apply(this, arguments);
                  }
                  if (isDefined(value)) {
                    scope2.$$postDigest(function() {
            ...
            function oneTimeLiteralWatchDelegate(scope, listener, objectEquality, parsedExpression) {
              ...
              unwatch = scope.$watch(
                ...
                function oneTimeListener(value, old, scope2) {
                  lastValue = value;
                  if (isFunction(listener)) {
                    listener.call(this, value, old, scope2);
                  }
        ...
        function qFactory(nextTick, exceptionHandler) {
          ...
          extend(Deferred.prototype, {
            ...
            $$resolve: function(val) {
              ...
              function resolvePromise(val2) {
                if (done) return;
                done = true;
                that.$$resolve(val2);
              }
              function rejectPromise(val2) {
                if (done) return;
                done = true;
                that.$$reject(val2);
              }
            ...
            function($exceptionHandler, $parse, $browser) {
              ...
              Scope.prototype = {
                ...
                $evalAsync: function(expr, locals) {
                  ...
                  asyncQueue.push({ scope: this, expression: $parse(expr), locals });
                },
                ...
                return {
                  pre: function ngFormPreLink(scope, formElement2, attr2, ctrls) {
                    ...
                    if (!("action" in attr2)) {
                      ...
                      addEventListenerFn(formElement2[0], "submit", handleFormSubmission);
                      formElement2.on("$destroy", function() {
                        $timeout(function() {
                          removeEventListenerFn(formElement2[0], "submit", handleFormSubmission);
                        }, 0, false);
                      });
                    }
          ...
          function($scope, $exceptionHandler, $attr, $element, $parse, $animate, $timeout, $rootScope, $q, $interpolate) {
            ...
            this.$$setOptions = function(options) {
              ...
              if (options && options.getterSetter) {
                ...
                ngModelGet = function($scope2) {
                  var modelValue = parsedNgModel($scope2);
                  if (isFunction(modelValue)) {
                    modelValue = invokeModelGetter($scope2);
                  }
                  return modelValue;
                };
                ngModelSet = function($scope2, newValue) {
                  if (isFunction(parsedNgModel($scope2))) {
                    invokeModelSetter($scope2, { $$$p: newValue });
                  } else {
                    parsedNgModelAssign($scope2, newValue);
                  }
                };
            ...
            this.$validate = function() {
              ...
              ctrl.$$runValidators(modelValue, viewValue, function(allValid) {
                if (!allowInvalid && prevValid !== allValid) {
                  ctrl.$modelValue = allValid ? modelValue : void 0;
            ...
            this.$$parseAndValidate = function() {
              ...
              parserValid = isUndefined(modelValue) ? void 0 : true;
              if (parserValid) {
              ...
              return {
                ...
                post: function ngModelPostLink(scope, element2, attr, ctrls) {
                  ...
                  if (modelCtrl.$options && modelCtrl.$options.updateOn) {
                    element2.on(modelCtrl.$options.updateOn, function(ev) {
        ...
        function addSetValidityMethod(context) {
          ...
          function setValidity(validationErrorKey, state, controller) {
            ...
            if (ctrl.$pending) {
              ...
              ctrl.$valid = ctrl.$invalid = void 0;
            ...
            return {
              ...
              getWatchables: $parse(valuesFn, function(optionValues) {
                ...
                for (var index = 0; index < optionValuesLength; index++) {
                  ...
                  var locals2 = getLocals(value, key);
        ...
        var ngPluralizeDirective = ["$locale", "$interpolate", "$log", function($locale, $interpolate, $log) {
          ...
          return {
            link: function(scope, element, attr) {
              var numberExp = attr.count, whenExp = attr.$attr.when && element.attr(attr.$attr.when), offset = attr.offset || 0, whens = scope.$eval(whenExp) || {}, whensExpFns = {}, startSymbol = $interpolate.startSymbol(), endSymbol = $interpolate.endSymbol(), braceReplacement = startSymbol + numberExp + "-" + offset + endSymbol, watchRemover = angular3.noop, lastCount;
            ...
            compile: function ngRepeatCompile($element, $attr) {
              ...
              return function ngRepeatLink($scope, $element2, $attr2, ctrl, $transclude) {
                ...
                $scope.$watchCollection(rhs, function ngRepeatAction(collection) {
                  var index, length, previousNode = $element2[0], nextNode, nextBlockMap = createMap(), collectionLength, key, value, trackById, trackByIdFn, collectionKeys, block, nextBlockOrder, elementsToRemove;
                  if (aliasAs) {
          ...
          return {
            ...
            compile: function(element, attr) {
              ...
              return function(scope, element2, attr2) {
                ...
                if (selectCtrl) {
                  selectCtrl.registerOption(scope, element2, attr2, hasDynamicValueAttr, interpolateTextFn);
                }
              };
            }
          };
        ...
        jqLite(window2.document).ready(function() {
  ...
  var require_LoginController = __commonJS({
    "public/js/controllers/LoginController.js"(exports, module) {
      module.exports = [
        "$scope",
        "$http",
        "$window",
  ...
  // public/js/controllers/RegistrationController.js
  var require_RegistrationController = __commonJS({
    "public/js/controllers/RegistrationController.js"(exports, module) {
      module.exports = [
        "$scope",
        "$http",
        function RegistrationController($scope, $http) {
          ...
          $scope.submitRegistration = function submitRegistration() {
            ...
            if ($scope.formData.password && $scope.formData.password_confirmation && $scope.formData.password !== $scope.formData.password_confirmation) {
            ...
            $http.post("/register", {
              ...
              $scope.serverError = error.data && error.data.error || "Registration failed. Please try again.";
            }).finally(function onFinally() {
              $scope.isSubmitting = false;
            });
          };
  ...
  // public/js/controllers/PasswordRecoveryController.js
  var require_PasswordRecoveryController = __commonJS({
    "public/js/controllers/PasswordRecoveryController.js"(exports, module) {
      module.exports = [
        "$scope",
        "$http",
        "$window",
        function PasswordRecoveryController($scope, $http, $window) {
          ...
          $scope.submitNewPassword = function submitNewPassword() {
            ...
            $http.post("/newpassword", {
              ...
              $scope.serverError = error.data && error.data.error || "Password reset failed. Please request a new recovery link.";
            }).finally(function onFinally() {
              $scope.isSubmitting = false;
            });
          };
  ...
  // public/js/entrypoints/auth.js
  var angular2 = require_angular2();
  var authModule = require_auth_module();
  angular2.module("EthicAppAuth", [authModule]);
})();
